  ...
  <div class="col-lg-12">
      <div class="card">
        ...
        <div class="card-body">
         ...
         @endif
        <form class="form form-horizontal" action="{{url('users/' . $users->id)}}" method="POST">
            {{csrf_field()}}
            @method("PATCH")
          <div class="form-body">
              <div class="form-group row">
                  ...
                  <div class="col-md-9">
                      <input type="text" id="projectinput1" class="form-control" name="name" value="{{$users->name}}" >
                  </div>
                  <span id="s1"> </span>
              ...
              <div class="form-group row">
                ...
                <div class="col-md-9">
                    <input type="text" id="projectinput1" class="form-control" name="email" value="{{$users->email}}" >
                </div>
                <span id="s1"> </span>
            </div>
              ...
              <div class="form-group row">
                  ...
                  <div class="col-md-9">
                      <input type="text" id="projectinput1" class="form-control" name="password" value="{{$users->password}}" >
                  </div>
                  <span id="s1"> </span>
              </div>
            ...
            <div class="form-group row">
              ...
              <div class="col-md-9">
                <select id="projectinput7" name="type" class="form-control">
                    ...
                    <option value="1" <?php if( $users['type'] == '1'){echo "selected";} ?> >Admin</option>
                    <option value="0" <?php if( $users['type'] == '0'){echo "selected";} ?>>user</option> 
