...
<div class="row">
    <div class="col-sm-12">
        <h2 class="content-header">AEdit Employees Form</h2>
    </div>
</div>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="px-3">
                    ...
                    <form class="form form-horizontal" action= "{{url('employees/' . $employees->id)}}" method="POST">
                        {{csrf_field()}}
						@method("PUT")
                        <div class="form-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <input type="text" id="projectinput1" class="form-control" name="fname" value="{{$employees->emp_name}}" >
                                    @error('fname')
                ...
                <span id="res1"> </span>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <input type="text" id="projectinput2" class="form-control" name="lname" value="{{$employees->emp_address}}" >
                                    @error('lname')
                                        <div class="form-error">
                                            {{$message}}
                                        </div>                                   
              ...
              <span id="res2"> </span>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <input type="text" id="projectinput3" class="form-control" name="email" value="{{$employees->emp_email}}" >
                                    @error('email')
                                        <div class="form-error">
                                            {{$message}}
                                        </div>
              ...
              <span id="res3"> </span>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <input type="text" id="projectinput4" class="form-control" name="phone" value="{{$employees->emp_phone}}" >
                                    @error('phone')
                                        <div class="form-error">
                                            {{$message}}
                                        </div>  
              ...
              <div class="col-md-9">
                <div class="position-relative has-icon-left">
                  <input type="date" id="timesheetinput3" class="form-control" name="date" value="{{$employees->emp_bd}}" >
                    @error('date')
                        <div class="form-error">
                            {{$message}}
                        </div>
            ...
            <div class="form-group row">
                ...
                <input type="radio" id="projectinput9"  name="Type" value="Male"  <?php if( $employees['emp_gender'] == 'Male'){echo "checked";} ?> >
                <label for="male">Male</label>
                <input type="radio"  id="projectinput9" name="Type" value="Female" <?php if( $employees['emp_gender'] == 'Female'){echo "checked";} ?> >
            ...
            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <input type="text" id="projectinput10" class="form-control" name="Dateofcontract" value="{{$employees->hiredate}}" >
            ...
            <div class=" row">
                  ...
                  <label class="col-md-3 label-control" >Start time: </label>
                                        <div class="position-relative has-icon-left col-lg-9">
                                            <input type="time" id="timesheetinput5" class="form-control" name="starttime" value="{{$employees->emp_in}}" >
                                                @error('starttime')
                                                    <div class="form-error">
                                                        {{$message}}
                                                    </div>
                  ...
                  <label class="col-md-3 label-control" >End time: </label>
                                        <div class="position-relative has-icon-left col-lg-9">
                                            <input type="time" id="timesheetinput6" class="form-control" name="endtime" value="{{$employees->emp_out}}" >
                                                @error('endtime')
                                                    <div class="form-error">
                                                        {{$message}}
                                                    </div>
                    ...
                    <span id="res9"> </span>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <input id="projectinput7" type="text" name="salary" class="form-control" value="{{$employees->salary}}" >
                                        @error('salary')
                                            <div class="form-error">
                                                {{$message}}
                                            </div>
                   ...
                   <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <input type="text" id="projectinput11" class="form-control" name="NationalID" value="{{$employees->nationalid}}" >
                                        @error('NationalID')
                                            <div class="form-error">
                                                {{$message}}
                                            </div>
            ...
            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <input type="text" id="projectinput12" class="form-control" name="Nationality" value="{{$employees->nationality}}" >
                                        @error('Nationality')
                                            <div class="form-error">
                                                {{$message}}
                                            </div>
