                                 ...
                                 <div id="carousel-example-caption" class="carousel slide" data-ride="carousel">
                                    ...
                                    <div class="carousel-inner" role="listbox">
                                       <div class="carousel-item active">
                                          <img src="{{URL::asset('app-assets/img/slide.PNG')}}" alt="First slide">
                                       </div>
                                       <div class="carousel-item">
                                          <img src="{{URL::asset('app-assets/img/slide2.PNG')}}" alt="Second slide">
                                       </div>
                                       <div class="carousel-item">
                                          <img src="{{URL::asset('app-assets/img/slide3.PNG')}}" alt="Third slide">
                                       </div>
                                    </div>
