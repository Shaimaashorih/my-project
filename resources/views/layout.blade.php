...
<head>
    ...
    <link rel="apple-touch-icon" sizes="60x60" href="{{URL::asset('app-assets/img/ico/apple-icon-60.html')}}">
    <link rel="apple-touch-icon" sizes="76x76" href="{{URL::asset('app-assets/img/ico/apple-icon-76.html')}}">
    <link rel="apple-touch-icon" sizes="120x120" href="{{URL::asset('app-assets/img/ico/apple-icon-120.html')}}">
    <link rel="apple-touch-icon" sizes="152x152" href="{{URL::asset('app-assets/img/ico/apple-icon-152.html')}}">
    <link rel="shortcut icon" type="image/png" href="{{URL::asset('app-assets/img/logo.png')}}">
  ...
  <body data-col="2-columns" class=" 2-columns ">
    <div class="wrapper">
      ...
      <div data-active-color="white" data-background-color="black" data-image="{{URL::asset('app-assets/img/sidebar-bg/01.jpg')}}" class="app-sidebar">
        <div class="sidebar-header">
          <div class="logo clearfix"><a href="{{url('/' . 'dash')}}" class="logo-text float-left">
              <div class="logo-img"><img src="{{URL::asset('app-assets/img/logo.png')}}" alt=""/></div><span class="text align-middle">Hr System</span></a>
        ...
        <div class="sidebar-content">
          <div class="nav-container">
             <ul id="main-menu-navigation" data-menu="menu-navigation" class="navigation navigation-main">
                <li class="nav-item home"><a href="{{url('/' . 'dash')}}"><i class="icon-home"></i><span data-i18n=""
                   class="menu-title">Dashboard</span></a>
                </li>
                <li class="has-sub nav-item">
                   <a href="#"><i class="icon-users"></i><span data-i18n="" class="menu-title"> Employees</span></a>
                   <ul class="menu-content">
                      <li><a href="{{url('/' . 'employees')}}" class="menu-item"> <i class="icon-bar"></i> Employees Statistics</a>
                      </li>
                      <li><a href="{{url('/' . 'employees/create')}}" class="menu-item">Add Employee</a>
                      </li>
                   </ul>
                </li>
                <li class=" nav-item"><a href="{{url('/' .'employees/create')}}"><i class="icon-note"></i><span data-i18n="" class="menu-title">Add Employee</span></a>
                </li>
                <li class=" nav-item"><a href="{{url('/' .'general_settings')}}"><i class="icon-pie-chart"></i><span data-i18n="" class="menu-title">
                   General Settings</span></a>
                </li>
                <li class=" nav-item"><a href="{{url('/' .'attendances')}}"><i class="icon-support"></i><span data-i18n="" class="menu-title">
                   Attendance</span></a>
                </li>
                <li class=" nav-item"><a href="{{url('/' .'salary_report')}}"><i class="icon-layers"></i><span data-i18n="" class="menu-title">Salary report</span></a>
                </li>
                <li class=" nav-item"><a href="{{url('/' .'users')}}"><i class="icon-users"></i><span data-i18n="" class="menu-title">Users</span></a>
                </li>
                <li class=" nav-item"><a href="{{url('/' .'permissions')}}"><i class="icon-equalizer"></i><span data-i18n="" class="menu-title">Permissions</span></a>
                </li>
                <li class=" nav-item"><a href="{{url('/' .'chat')}}"><i class="icon-puzzle"></i><span data-i18n="" class="menu-title">Chat</span></a>
                </li>
               
                <li class=" nav-item"><a href="{{url('/' .'login')}}"><i class="icon-pin"></i><span data-i18n="" class="menu-title">Login Page </span></a>
                 </li>
             </ul>
          </div>
       </div>
          ...
          <div class="navbar-header">
            ...
            <div class="dropdown ml-2 display-inline-block"><a id="apps" href="#" data-toggle="dropdown" class="nav-link position-relative dropdown-toggle"><i class="ft-edit blue-grey darken-4"></i><span class="mx-1 blue-grey darken-4 text-bold-400">Apps</span></a>
              <div class="apps dropdown-menu">
                <div class="arrow_box"><a href="{{url ('/' . 'chat')}}" class="dropdown-item py-1"><span>Chat</span></a><a href="taskboard.html" class="dropdown-item py-1"><span>TaskBoard</span></a><a href="calendar.html" class="dropdown-item py-1"><span>Calendar</span></a></div>
              </div>
            </div>
          </div>
          <div class="navbar-container">
            <div id="navbarSupportedContent" class="collapse navbar-collapse">
              <ul class="navbar-nav">
                ...
                <li class="dropdown nav-item mr-0"><a id="dropdownBasic3" href="#" data-toggle="dropdown" class="nav-link position-relative dropdown-user-link dropdown-toggle"><span class="avatar avatar-online"><img id="navbar-avatar"  src="{{URL::asset('app-assets/img/portrait/small/avatar-s-3.jpg')}}" alt="avatar"></span>
                    <p class="d-none">User Settings</p></a>
                  <div aria-labelledby="dropdownBasic3" class="dropdown-menu dropdown-menu-right">
                    <div class="arrow_box_right"><a href="user-profile-page.html" class="dropdown-item py-1"><i class="ft-edit mr-2"></i><span>My Profile</span></a><a href="{{url('/' . 'chat')}}" class="dropdown-item py-1"><i class="ft-message-circle mr-2"></i><span>My Chat</span></a><a href="javascript:;" class="dropdown-item py-1"><i class="ft-settings mr-2"></i><span>Settings</span></a>
    ...
    <div class="customizer border-left-blue-grey border-left-lighten-4 d-none d-sm-none d-md-block"><a class="customizer-close"><i class="ft-x font-medium-3"></i></a><a id="customizer-toggle-icon" class="customizer-toggle bg-danger"><i class="ft-settings font-medium-4 fa fa-spin white align-middle"></i></a>
      <div data-ps-id="df6a5ce4-a175-9172-4402-dabd98fc9c0a" class="customizer-content p-3 ps-container ps-theme-dark">
        ...
        <div class="cz-bg-image row">
          <div class="col mb-3"><img src="{{URL::asset('app-assets/img/sidebar-bg/01.jpg')}}" width="50" height="100" alt="Bg image1" class="rounded box-shadow-2"></div>
          <div class="col mb-3"><img src="{{URL::asset('app-assets/img/sidebar-bg/02.jpg')}}" width="50" height="100" alt="Bg image2" class="rounded box-shadow-2"></div>
          <div class="col mb-3"><img src="{{URL::asset('app-assets/img/sidebar-bg/03.jpg')}}" width="50" height="100" alt="Bg image3" class="rounded box-shadow-2"></div>
          <div class="col mb-3"><img src="{{URL::asset('app-assets/img/sidebar-bg/04.jpg')}}" width="50" height="100" alt="Bg image4" class="rounded box-shadow-2"></div>
          <div class="col mb-3"><img src="{{URL::asset('app-assets/img/sidebar-bg/05.jpg')}}" width="50" height="100" alt="Bg image5" class="rounded box-shadow-2"></div>
          <div class="col mb-3"><img src="{{URL::asset('app-assets/img/sidebar-bg/06.jpg')}}" width="50" height="100" alt="Bg image6" class="rounded box-shadow-2"></div>
          <div class="col mb-3"><img src="{{URL::asset('app-assets/img/sidebar-bg/07.jpg')}}" width="50" height="100" alt="Bg image7" class="rounded box-shadow-2"></div>
          <div class="col mb-3"><img src="{{URL::asset('app-assets/img/sidebar-bg/08.jpg')}}" width="50" height="100" alt="Bg image8" class="rounded box-shadow-2"></div>
        </div>
        <hr>
        <div class="togglebutton">
    ...
    <!-- BEGIN VENDOR JS-->
    <script src="{{URL::asset('app-assets/vendors/js/core/jquery-3.3.1.min.js')}}"></script>
    <script src="{{URL::asset('app-assets/vendors/js/core/popper.min.js')}}"></script>
    <script src="{{URL::asset('app-assets/vendors/js/core/bootstrap.min.js')}}"></script>
    <script src="{{URL::asset('app-assets/vendors/js/perfect-scrollbar.jquery.min.js')}}"></script>
    <script src="{{URL::asset('app-assets/vendors/js/prism.min.js')}}"></script>
    <script src="{{URL::asset('app-assets/vendors/js/jquery.matchHeight-min.js')}}"></script>
    <script src="{{URL::asset('app-assets/vendors/js/screenfull.min.js')}}"></script>
    <script src="{{URL::asset('app-assets/vendors/js/pace/pace.min.js')}}"></script>
    <script src="{{URL::asset('app-assets/vendors/js/chartist.min.js')}}"></script>
    <script src="{{URL::asset('app-assets/js/app-sidebar.js')}}"></script>
    <script src="{{URL::asset('app-assets/js/notification-sidebar.js')}}"></script>
    <script src="{{URL::asset('app-assets/js/customizer.js')}}"></script>
    <script src="{{URL::asset('app-assets/js/dashboard-ecommerce.js')}}"></script>
  </body>
</html>